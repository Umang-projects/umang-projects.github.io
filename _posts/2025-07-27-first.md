---
title: "GPUs Are Lazy: Why Your Matrix Multiplication Is Wasting 37% Memory."
subtitle: "How tiling slashed runtime by 5.3 seconds and made CUDA kernels 1.58x faster benchmarked at 16K×16K."
...
| ---------------------- | ---------- | --------- | ------------ | ---------- |
| Baseline (Coalesced)   | 14.32 s    | 1.00×     | —            | —          |
| **Tiled Optimization** | **9.04 s** | **1.58×** | **\~37%**    | **5.28 s** |
